...
export class QuestionBankSeederService {
   ...
   */
  private createQuestion(category: string, difficulty: string, index: number): any {
      ...
      machine_learning: [
        {
          ...
          correctAnswer: 1,
          explanation: 'Regularization adds a penalty term to prevent overfitting by discouraging complex models.'
        },
        {
          question: 'Which algorithm is best suited for binary classification with linearly separable data?',
          options: ['K-Means', 'Linear SVM', 'DBSCAN', 'PCA'],
          correctAnswer: 1,
          explanation: 'Linear SVM finds the optimal hyperplane for linearly separable binary classification.'
        },
        {
          ...
          correctAnswer: 1,
          explanation: 'The bias-variance tradeoff balances model complexity (variance) with generalization ability (bias).'
        }
      ],
      deep_learning: [
        {
          ...
          correctAnswer: 1,
          explanation: 'Vanishing gradients occur when gradients become extremely small in early layers, preventing effective learning.'
        },
        {
          question: 'Which activation function helps mitigate the vanishing gradient problem?',
          options: ['Sigmoid', 'Tanh', 'ReLU', 'Linear'],
          correctAnswer: 2,
          explanation: 'ReLU maintains gradients for positive values, helping prevent vanishing gradients.'
        }
      ],
      nlp: [
        {
          ...
          correctAnswer: 1,
          explanation: 'Attention mechanisms allow models to focus on relevant parts of the input sequence.'
        },
        {
          ...
          correctAnswer: 1,
          explanation: 'BERT uses bidirectional transformers to create contextual word embeddings.'
        }
      ],
      computer_vision: [
        {
          question: 'What is the primary advantage of convolutional layers in CNNs?',
          options: [
            'Faster training',
          ...
          correctAnswer: 1,
          explanation: 'Convolutional layers share parameters across spatial locations, reducing parameters and capturing spatial patterns.'
        }
      ],
      mlops: [
        {
          ...
          correctAnswer: 1,
          explanation: 'Model drift occurs when model performance degrades due to changes in data distribution.'
        }
      ],
      general_ai: [
        {
