...
export class ProductModerationService {
  ...
  async moderateUpdate(data: {
    ...
    if (data.tags && data.tags.length > 0)
      textParts.push(`Tags: ${data.tags.join(", ")}`);
