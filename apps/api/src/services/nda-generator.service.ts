  ...
  private generateNDAContent(doc: PDFKit.PDFDocument, data: NDAData): void {
    ...
    const terms = [
      ...
      },
      {
        title: "3. Exclusions",
        content:
          "This Agreement does not apply to information that: (a) is or becomes publicly available through no breach of this Agreement; (b) was rightfully in the possession of the Receiving Party prior to disclosure; (c) is independently developed by the Receiving Party without use of Confidential Information; (d) is rightfully obtained from a third party without breach of confidentiality obligations.",
      },
      {
        title: "4. Term",
        content:
          "This Agreement shall remain in effect for a period of 2 years from the date of signing, or until the Confidential Information no longer qualifies as confidential, whichever is later.",
      },
      {
        title: "5. Return of Materials",
        content:
          "Upon completion of the task or upon request by the Disclosing Party, the Receiving Party shall promptly return or destroy all Confidential Information and certify such destruction in writing.",
      },
      {
        title: "6. No License",
        content:
          "Nothing in this Agreement grants any license or right to the Receiving Party under any patent, copyright, trade secret, or other intellectual property right.",
      },
      {
        title: "7. Remedies",
        content:
      ...
      },
      {
        ...
        content:
          "This Agreement shall be governed by and construed in accordance with the laws of India. Any disputes arising under this Agreement shall be subject to the exclusive jurisdiction of courts in India.",
      },
    ];
    ...
    terms.forEach((term, index) => {
      ...
      doc.font("Helvetica-Bold").text(term.title, { indent: 20 }).moveDown(0.3);
    ...
    doc
      ...
      .text(
        "This is a legally binding agreement. By signing, you acknowledge that you have read, understood, and agree to be bound by the terms and conditions of this Non-Disclosure Agreement.",
        {
          align: "center",
          indent: 20,
        },
    ...
    return new Promise(async (resolve, reject) => {
      try {
        ...
        doc
          ...
          .text("Signature verified by NeuronHire Platform", {
            align: "center",
          });
