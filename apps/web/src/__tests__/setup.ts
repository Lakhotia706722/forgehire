...
jest.mock('@/lib/api-hooks', () => ({
  ...
  useNeuronScoreHistory: () => ({ data: [], isLoading: false, error: null }),
  // Admin list hooks
  useAdminEngineers: () => ({
    data: {
      engineers: [
  ...
  useContractDetail: (id: string) => ({
    data: {
      ...
      milestones: [
        { id: 'm1', milestoneNumber: 1, title: 'STT Pipeline', description: 'Build speech-to-text pipeline', amount: 50000, status: 'paid', dueDate: new Date(Date.now() - 5 * 86400000).toISOString(), submittedAt: new Date(Date.now() - 7 * 86400000).toISOString(), approvedAt: new Date(Date.now() - 5 * 86400000).toISOString(), paidAt: new Date(Date.now() - 5 * 86400000).toISOString() },
        { id: 'm2', milestoneNumber: 2, title: 'LLM Integration', description: 'Integrate LLM for NLU', amount: 60000, status: 'submitted', dueDate: new Date(Date.now() + 3 * 86400000).toISOString(), submittedAt: new Date(Date.now() - 1 * 3600000).toISOString(), approvedAt: null, paidAt: null },
        { id: 'm3', milestoneNumber: 3, title: 'TTS & Deployment', description: 'Text-to-speech and deploy', amount: 40000, status: 'pending', dueDate: new Date(Date.now() + 14 * 86400000).toISOString(), submittedAt: null, approvedAt: null, paidAt: null },
      ],
    },
    isLoading: false,
    error: null,
  ...
  useProductAnalytics: () => ({ data: null, isLoading: false, error: null }),
}));
