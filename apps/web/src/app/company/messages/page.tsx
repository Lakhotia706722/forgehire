        ...
        <div className="flex-1 px-4 py-4 space-y-4">
          {activeConv?.contractId && (
            <div className="space-y-2">
              ...
              <a href={`/company/contracts/${activeConv.contractId}`} className="flex items-center gap-2 p-2.5 bg-bg-elevated rounded-xl border border-[rgba(255,255,255,0.06)] hover:border-[rgba(0,212,255,0.2)] transition-colors group">
          ...
          <div className="space-y-2">
            ...
            {[
              ...
              { label: 'Post a Job',   icon: '📝', href: '/company/post-task' },
            ].map((link) => (
